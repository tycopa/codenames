...
const WORDS = {
  ...
  en: {
    easy: [
      ...
      "Cord","Core","Crag","Crest","Crisp","Crop","Cub","Curl","Dab",
      ...
      "Dwarf","Eddy","Eel","Emblem","Ember","Enclave","Escarp","Fawn",
      ...
      "Jaguar","Jasper","Jolt","Juniper","Kale","Kelp",
      ...
      "Narwhal","Newt","Niche","Nightingale","Nodule","Nook","Notch","Ochre","Offal",
      "Osprey","Ox","Paddock","Pampas","Panther","Parcel","Parsley","Partridge","Patch","Peat",
      "Pelican","Perch","Pike","Pilchard","Plum","Polecat",
      "Poplar","Porpoise","Pouch","Prowl","Puffin","Pulp","Puma","Punt","Pygmy","Quaff",
      "Quagmire","Quicksand","Radish","Rail","Rake","Rampart","Raptor","Ravine","Refuge",
      ...
      "Shank","Shoal","Shrew","Shrub","Shuck","Skylark","Slab","Sloe","Sloth",
      "Slug","Snipe","Sow","Spaniel","Spawn","Sprat","Squirrel","Stack","Stalk","Stallion",
      "Starfish","Stint","Stoat","Stock","Stork","Stubble","Swede","Swift","Sycamore",
      "Talon","Teal","Tern","Thicket","Thistle","Thorn","Thyme","Tide","Timber","Titmouse",
      "Torrent","Trace","Trident","Trout","Tuber","Tumble","Turbot","Twilight",
      "Viper","Vole","Wake","Wallow","Walrus","Warbler","Wayfarer","Weasel","Wetland",
      "Whin","Whittle","Wildcat","Winkle","Wren","Yew",
      // ── additional easy words ──
      "Joy","Fear","Hope","Love","Trust","Calm","Pride","Rage","Grief","Envy",
      "Bliss","Dread","Awe","Woe","Glee","Zeal","Spite","Scorn","Mirth",
      ...
      "Pond","Creek","Brook","Beck","Rill","Gully","Ravine","Gorge","Chasm",
      "Peak","Crag","Bluff","Cliff","Plateau","Mesa","Butte","Dune","Delta",
      ...
      "Car","Bus","Table","Window","Plate","Spoon","Knife","Run","Jump","Walk",
      "Hot","Cold","Big","Small","Girl","Man","Shirt","Swim","Toy","Glass",
      "Butter","Color","Dance","Song","Game",
],
    hard: [
      ...
      // ── moved from easy ──
      "Cormorant","Estuary","Eyrie","Jackdaw","Kestrel","Knap","Lapwing","Nuthatch","Pewit","Pipit",
      "Plover","Pochard","Redstart","Skua","Sundew","Trefoil","Vetch","Wagtail","Wigeon","Wrasse",
      "Yarrow","Zooplankton","Angst","Abyss","Escarpment",
],
  },
  ...
  es: {
    easy: [
      ...
      "Carbón","Carne","Caza","Cedro","Cereal","Cereza","Cerdo","Cerveza","Charca",
      ...
      "Gorrión","Granada","Granja","Grieta","Grillo","Guante","Guisante","Helecho","Hierba",
      ...
      "Berro","Berzas","Bledo","Boceto","Boga","Bonito",
      "Brécol","Brezo","Brizna","Brote","Bruma","Buitre","Burbuja","Caballete","Cabaña","Cabestro",
      "Cacatúa","Cadejo","Caldera","Cangrejo","Cantil","Capricho","Capullo",
      "Cauce","Caza","Cazador","Cenicero","Ceniza","Cierzo",
      "Ciprés","Circo","Cirio","Claro","Clavel","Cobijo","Codorniz","Colilla",
      "Colinabo","Colono","Comadreja","Corcova","Costal","Cotorra","Coyote","Cuajada","Cuco",
      "Culebra","Cuñete","Damasco","Dardo","Diente","Duna","Emboscada","Encina",
      "Enebro","Enredadera","Entorno","Ermita","Escoba","Espino","Esponja","Estero",
      "Faisán","Falda","Fauno","Flamenco","Flechazo","Flojo","Follaje","Fontana","Forja",
      "Fosa","Fragua","Gaviota","Geranio","Gorrino","Grulla","Guadaña",
      ...
      "Pleamar","Plomo","Polvo","Porrón","Pradal","Proa","Puma","Punzón","Purín",
      ...
      // ── simpler replacements ──
      "Coche","Tren","Mesa","Ventana","Plato","Cuchara","Cuchillo","Niña","Hombre","Camisa",
      "Juguete","Vaso","Calor","Frío","Canción","Baile","Juego","Balón","Lápiz","Libro",
      "Silla","Puerta","Pan","Leche","Taza",
],
    hard: [
      ...
      // ── moved from easy ──
      "Celosía","Gurbia","Bellotera","Berberecho","Bisbita","Bóveda","Calandria","Cañaveral","Caramillo","Cardillo",
      "Cardón","Cayado","Cigala","Cimbra","Cistus","Desfiladero","Égida","Escollera","Espadaña","Fabada",
      "Fresneda","Fronda","Gazapo","Cormoran","Prosopis",
],
  },
  ...
  fr: {
    easy: [
      ...
      "Avalanche","Avoine","Azalée","Bardane","Barrage","Belette","Berce","Bison",
      "Blaireau","Bolet","Brochet","Bruant","Brume","Busard",
      "Capucine","Carpe","Cassis","Cerf","Cerfeuil","Chardonneret","Châtaigne","Chouette","Chrysanthème","Cigale",
      "Citron","Civette","Clématite","Colchique","Combe","Coucou","Coulis",
      "Crevette","Crocus","Cytise","Écrevisse","Élan","Épervier","Éphémère",
      "Étang","Falaise","Fauvette","Fourmi","Framboise","Fraxinelle","Friche",
      "Fromental","Gaillarde","Genet","Géranium","Giroflée","Gîte","Gorge",
      "Goutte","Graminée","Grèbe","Grolle","Groseille","Guêpier",
      "Houblon","Huppe","Ibis","If","Jacinthe","Jasmin","Juniperus","Lampion","Lande",
      "Lapin","Lentille","Lérot","Linotte","Liseron","Loir","Loriot","Lupin","Luzule",
      ...
      "Pissenlit","Pivoine","Polatouche","Polypode","Potentille","Primevère","Pulicaire","Putois",
      ...
      "Zostère",
      // ── simpler replacements ──
      "Voiture","Train","Table","Fenêtre","Assiette","Cuillère","Couteau","Fille","Homme","Chemise",
      "Jouet","Verre","Chaud","Froid","Grand","Petit","Chanson","Danse","Jeu","Ballon",
      "Crayon","Livre","Chaise","Porte","Pain",
],
    hard: [
      ...
      // ── moved from easy ──
      "Avocette","Bergeronnette","Bouvreuil","Buse","Butome","Cirse","Conopode","Coprin","Épervière","Érismature",
      "Estran","Fétuque","Fléole","Fluviatile","Fuligule","Fumeterre","Gallinule","Grimpereau","Guifette","Gypaète",
      "Hêtraie","Laîche","Bittern","Pipit","Pouillot",
],
  },
  ...
  de: {
    easy: [
      ...
      "Baummarder","Berggams","Blaubeere","Blutbuche","Bodendeckel",
      "Brombeere","Brombeerstrauch","Damhirsch","Delphin",
      "Edelweiss","Eibe","Eidechse","Eisvogel","Elbeite","Elfenblume","Ernte",
      "Esche","Faulbaum","Faulpelz","Feddich","Felshuhn","Fensterkreuz","Feuerfalter","Fichtenzapfen","Fischadler",
      "Flachs","Flattergras","Floh","Flußbarsch","Forellensee","Frühling","Fuchsschwanz",
      "Gärtnerblume","Gauk","Gewürzstrauch","Ginster","Glasauge","Glitzerstern","Goldregen","Goldammer","Gämsbart",
      "Hagedorn","Hamster","Hecke","Heilkraut","Helmkraut","Heuschrecke","Himbeerstrauch",
      "Hirtentäschel","Hohlweg","Hornisse","Husarenknopf","Hagebutte","Johannisbeere","Karpfen",
      ...
      // ── simpler replacements ──
      "Auto","Bus","Tisch","Fenster","Teller","Löffel","Messer","Mädchen","Mann","Hemd",
      "Spielzeug","Glas","Heiß","Kalt","Groß","Klein","Lied","Tanz","Spiel","Ball",
      "Bleistift","Buch","Stuhl","Tür","Brot",
],
    hard: [
      ...
      // ── moved from easy ──
      "Bekassine","Bergdohle","Birkhuhn","Blässhuhn","Blaukehlchen","Bruchweide","Buchfink","Buchwanze","Dachsbau","Distelfalter",
      "Dohlenansiedlung","Dornbusch","Dreizehenmöwe","Erlkönig","Falkner","Flunder","Frauenschuh","Gänsegeier","Graureiher","Habicht",
      "Haubentaucher","Hausrotschwanz","Kiebitz","Kirchturmfalke","Kleiber",
],
  },
  ...
  pt: {
    easy: [
      ...
      "Cipestre","Cobra","Cogumelo","Cordeiro","Coruja","Couto","Cravo","Cristal","Cruz",
      ...
      "Abutre","Alcedo","Alfazema","Alheira","Alicate","Alisos","Alóe",
      "Altivo","Álvaro","Amendoim","Amora","Ananás","Andorinhas","Aníbal",
      "Anicho","Anileira","Antúrio","Anzol","Apoio","Aquífero","Arame","Aranha","Arcaz","Ardósia",
      "Aredão","Arenque","Argola","Aroeira","Arranha","Arrieiros","Artémia","Asa","Asno",
      "Aspargo","Assobiador","Atalho","Atum","Azinheiro","Babosa","Bacelo",
      "Bacio","Bago","Baía","Baixo","Balsa","Bambu","Barbo","Barranco","Barreiro",
      "Barulho","Beija-flor","Bigorna","Bisonte","Bolota","Bolso","Bonito",
      "Bordo","Borrelho","Botuelho","Brejo","Broa","Bronze","Buxo","Caça","Cadmo",
      "Caloura","Camponês","Cancro","Capim",
      "Capuz","Caramujo","Carpa","Carraça","Carrasco","Cartaxo","Casca","Cascata","Casinha","Castor",
      "Catavento","Cavala","Cavidade","Cegonha","Centeio","Cerceta","Charcos","Chasco","Chilrear",
      "Cipó","Circo","Citrino","Ciúmes","Clamor","Codorniz","Columba","Cominho","Coralinho",
      "Corça","Corujinha","Cotovia","Crisálida","Crocante","Cromado","Curvelo","Demorou","Escabeche",
      // ── simpler replacements ──
      "Carro","Trem","Mesa","Janela","Prato","Colher","Faca","Menina","Homem","Camisa",
      "Brinquedo","Copo","Quente","Frio","Grande","Pequeno","Canção","Dança","Jogo","Bola",
      "Lápis","Livro","Cadeira","Porta","Pão",
],
    hard: [
      ...
      // ── moved from easy ──
      "Dendrobia","Alevinos","Alforje","Almofariz","Alpendurada","Alqueves","Alteia","Arundinária","Astrágalo","Atanor",
      "Azinhaga","Bagoeiro","Bilro","Boieiro","Bordão","Cagarras","Cagilo","Calatrava","Calombo","Clavícula",
      "Cormorão","Camaleão","Capivara","Bicho-da-seda","Catfish",
],
  },
  ...
  it: {
    easy: [
      "Abete","Acacia","Acero","Aglio","Agrume","Airone","Alce","Aliga","Alloro",
      ...
      "Alcione","Almadina","Alocasia","Alonzo","Altopiano","Amaranta","Ambrosia","Amfibio","Ammasso",
      "Anco","Anfibio","Angelica","Angiola","Animale","Anitra","Anone","Antilope","Aquilone",
      "Arachide","Arena","Argento","Ariete","Arrabiato",
      "Avena","Avvoltoio","Bacca","Balena","Balza","Banano",
      "Barcellona","Barbio","Bardana","Beccaccia","Beccaccino","Beccafico",
      "Biancospino","Bietola","Bisbita","Bissa","Bistorta","Boleto","Bottatrice","Branca",
      "Bufalo","Buglossa","Camoscio","Cannella","Capinera","Caprifico","Carpino","Cartamo",
      "Castoro","Caucale","Cedrela","Cervide","Cetriolo","Chiodino",
      "Cicouta","Cinorodo","Cipollone","Cirripedi","Clematis","Codirosso","Colobbo","Colombaccio","Conifera",
      ...
      // ── simpler replacements ──
      "Macchina","Treno","Tavolo","Finestra","Piatto","Cucchiaio","Coltello","Ragazza","Uomo","Camicia",
      "Giocattolo","Bicchiere","Caldo","Freddo","Grande","Piccolo","Canzone","Ballo","Gioco","Pallone",
      "Matita","Libro","Sedia","Porta","Pane",
],
    hard: [
      ...
      // ── moved from easy ──
      "Abisso","Alimurgia","Andropogon","Arcipelago","Artropode","Arum","Arvicola","Astragalo","Attinia","Avifauna",
      "Avocetta","Barbaforte","Barracuda","Beccamorto","Beccofrusone","Bertuccia","Bidens","Briozoi","Caimano","Canfora",
      "Caruncola","Cassia","Cerambice","Chirotteri","Ciconia",
],
  },
  ...
  me: {
    easy: [
      ...
      "Ledina","Lijeska","Lipa","List","Livada","Lješnjak","Lješnjik","Ljubičica",
      ...
      "Đurić","Farma","Fazan","Galeb","Garavan","Gavran","Gazda","Gazi",
      "Glina","Globus","Gnjev","Golub","Gvozd","Haluga","Hib",
      "Hvalja","Jasen","Javor","Ježeva","Jorgovan","Josipovac","Jug","Juha",
      "Jurić","Kaktus","Klješta","Klupa","Kocka",
      ...
      "Lavež","Ledena","Ler","Letva","Lje","Ljiljan","Logor","Lok",
      "Lop","Lovor","Lubarda","Luč","Luka","Lun","Lunta","Maćuhica","Maline",
      "Malter","Maslačak",
      // ── simpler replacements ──
      "Automobil","Autobus","Sto","Prozor","Tanjir","Kašika","Nož","Djevojka","Čovjek","Košulja",
      "Igračka","Čaša","Toplo","Hladno","Veliko","Malo","Pjesma","Ples","Igra","Lopta",
      "Olovka","Knjiga","Stolica","Vrata","Hljeb",
],
    hard: [
      ...
      // ── moved from easy ──
      "Entuzijazam","Gorge","Katedra","Glicin","Glib","Hidra","Humka","Hunjalo","Kapetanija","Kazimir",
      "Kmeta","Kobilica","Lantana","Lapor","Lebdilo","Ljupka","Mandela","Manita","Matica","Mavrica",
      "Meštar","Milka","Mahovine","Matičnjak","Mlin",
],
  },
  ...
  uk: {
    easy: [
      ...
      "Авокадо","Агрус","Аїр","Акула","Алича","Алое","Ананас","Анемона","Антилопа",
      "Арахіс","Аркуш","Арніка","Астра","Ателія","Аул","Бадилля","Бамбук","Барвінок","Баранець",
      "Барсук","Батіг","Берека","Бобовик","Болото","Борець","Борона","Бугай","Будяк",
      "Буйвол","Булава","Бурмиха","Бурштин","Буяння","Вивірка","Видра","Виноград","Вишневий","Вівця",
      "Вільха","Вітрило","Вівторок","Водоспад","Волошка","Вугор","Гадюка","Гвоздика",
      "Глобус","Гнат","Горобець","Горобина","Гречка",
      ...
      "Єдиноріг","Жайвір","Жало","Жар","Жасмин","Жито",
      "Залізо",
      // ── simpler replacements ──
      "Автомобіль","Автобус","Стіл","Вікно","Тарілка","Ложка","Ніж","Дівчина","Чоловік","Сорочка",
      "Іграшка","Склянка","Гарячий","Холодний","Великий","Маленький","Пісня","Танець","Гра","М'яч",
      "Олівець","Книга","Стілець","Двері","Хліб",
],
    hard: [
      ...
      // ── moved from easy ──
      "Єресть","Єрик","Ємшан","Єпископ","Жовтуга","Журба","Заболотній","Загайник","Зайвий","Залізняк",
      "Занедбаний","Заплава","Зарасти","Аконіт","Алчедон","Аурукарія","Бісер","Болиголов","Гетьман","Гичка",
      "Гірчиця","Гліцинія","Глід","Глухар","Гній",
],
  },
  ...
  ru: {
    easy: [
      ...
      "Видра","Виноград","Вьюнок","Гадюка","Гвоздика","Горобина","Гречиха","Гусь","Дельфин",
      ...
      "Цикорий","Цыплёнок","Чабрец","Чайка","Чернотал","Щавель","Ягель","Яструб","Ячмень",
      "Аврора","Агава","Акация","Акула","Алоэ","Альбатрос","Амарант",
      "Амфибия","Анаконда","Анис","Антей","Аралия","Аргус","Аркан","Армадилло","Арника","Арча",
      "Астрагал","Аурукария","Баклан","Бальзамин","Бамбук","Барвинок","Беркут","Бескид","Бобовник",
      "Бомбина","Бородавочник","Бурундук","Бурьян","Бутон","Варакушка","Василёк","Вахта","Вирея",
      "Волчник","Волчья ягода","Гвоздика","Гладиолус",
      ...
      "Ирга","Каштан","Кедровка","Ковыль",
      "Колокольчик","Коноплёвка","Крапива","Кропива","Крот","Кручёный",
      "Кувшинка","Купена","Кыргыз","Лаванда","Лебедь","Ледянка","Лесная","Ливень",
      // ── simpler replacements ──
      "Автомобиль","Автобус","Стол","Окно","Тарелка","Ложка","Нож","Девочка","Мужчина","Рубашка",
      "Игрушка","Стакан","Горячий","Холодный","Большой","Маленький","Песня","Танец","Игра","Мяч",
      "Карандаш","Книга","Стул","Дверь","Хлеб",
],
    hard: [
      ...
      // ── moved from easy ──
      "Вербейник","Выхухоль","Гагара","Гаичка","Гамадрил","Гарпия","Гигрофила","Камнеломка","Кермек","Клест",
      "Клоповник","Кобчик","Козодой","Кокушник","Короставник","Коршун","Кречет","Кутра","Лебеда","Авдотка",
      "Айкидо","Аласка","Алчедон","Болиголов","Болотянка",
],
  },
  ...
  pl: {
    easy: [
      ...
      "Czajka","Czapla","Czarna","Czeremcha","Czereśnia","Ćma","Dąb","Delfin","Deszcz",
      "Drewno","Drozd","Dzik","Dzięcioł","Fasola","Fiolek","Gąsienica","Głóg","Gniazdko","Gołąb",
      "Grzyb","Gwiazda","Jaskółka","Jeleń","Jodła","Jaskier","Jeż","Kaczka","Kamień",
      ...
      "Orzeł","Osika","Paproć","Piasek","Pies","Piorun","Pluskwa","Pszenica","Ptak",
      ...
      "Żywotnik","Bielik","Bławatek","Bobrownik","Borowik","Brzeg",
      "Czajka","Czarny","Drób","Dziki","Dzwoneczek",
      "Floks","Foki","Gacek","Gawron","Góral",
      "Granat","Grzywa","Haczyk","Jabłoń","Jałowiec","Jaskier",
      "Jeżówka","Jodłowy","Juniperus","Kajak","Kania","Karaś","Karczoch","Karpień",
      "Karze","Kasza","Kasztan","Kiszka","Kleśnik","Kłokoczka","Kmiotek","Kobuz",
      ...
      // ── simpler replacements ──
      "Samochód","Autobus","Stół","Okno","Talerz","Łyżka","Nóż","Dziewczyna","Mężczyzna","Koszula",
      "Zabawka","Szklanka","Gorący","Zimny","Duży","Mały","Piosenka","Taniec","Gra","Piłka",
      "Ołówek","Książka","Krzesło","Drzwi","Chleb",
],
    hard: [
      ...
      // ── moved from easy ──
      "Czmychaj","Kapuśniak","Płoć","Błotniak","Brodawkowiec","Brodziec","Cietrzew","Czubatka","Czyżyk","Dereszowata",
      "Dzierzba","Ekologia","Fakt","Fundament","Gdula","Ginąca","Grabówka","Graba","Grążel","Guziec",
      "Hełmiasty","Kaczan","Kapturnik","Kiełż","Kijanka",
],
  },
};
